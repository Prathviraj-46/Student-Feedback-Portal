  ...
  <body>
    ...
    <script>
        ...
        var subjectsByBranch = {
            AIDS: ["Automata Theory & Compiler Design", "Computer Networks", "Database Management System","Principles of AI"],
            AIML: ["Automata Theory & Compiler Design", "Computer Networks", "Database Management System","Principles of AI"],
            CSE: ["Automata Theory & Compiler Design", "Computer Networks", "Database Management System","Principles of AI"],
            ECE: ["Computer Communication Networks", "Microelectronic Circuits", "Digital Communication","Microwave Theory & Antennas"],
            IS: ["Automata Theory & Compiler Design", "Computer Networks", "Database Management System","AIML"],
        };
        ...
        function updateSubjects() {
            ...
            // Populate subjects based on the selected branch
            subjectsByBranch[selectedBranch].forEach(function (subject) {
        ...
        // Initial call to populate subjects based on the default branch
        updateSubjects();
    </script>
</body>
        </div>
